...
class AddStudent extends React.Component<any, any> {
  ...
  onFinish (values: any): void {
    const student = {
      ...
      idPhotoOne: this.state.portraitOneImg,
      idPhotoTwo: this.state.portraitTwoImg,
      idPhotoThree: this.state.portraitThreeImg,
      certGscan: this.state.contractImg
    }
    if (student.certFscan === null || student.certBscan === null || student.idPhotoOne === null) {
    ...
    axios.get('/student/getStudent', {
      ...
      if (data.success) {
        ...
        this.setState({
          ...
          contractImg: (student.certGscan && student.certGscan.length > 100) ? student.certGscan : null,
          portraitOneImg: (student.idPhotoOne && student.idPhotoOne.length > 100) ? student.idPhotoOne : null,
          portraitTwoImg: (student.idPhotoTwo && student.idPhotoTwo.length > 100) ? student.idPhotoTwo : null,
          portraitThreeImg: (student.idPhotoThree && student.idPhotoThree.length > 100) ? student.idPhotoThree : null
        })
      }
    })
  }
          ...
          <Row>
            <Col span={12}>
              <Form.Item
                ...
                label='证件照3'
              >
                {this.renderImg('portraitThreeImg')}
              </Form.Item>
            </Col>
            <Col span={12}>
              <Form.Item
  ...
  renderImg (imgName: string): ReactElement {
    return (
      ...
      >
        {this.state[imgName]
          ? <div>
            <img src={this.state[imgName]} alt="avatar" style={{ width: '400px',height:'400px' }} />
